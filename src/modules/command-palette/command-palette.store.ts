...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      category: 'External',
      description: 'View the source code of HetOps Tools on GitHub.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve HetOps Tools.',
      href: 'https://github.com/Het101/hetops-tools/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about HetOps Tools.',
      to: '/about',
      category: 'Pages',
